package it.agilelab.provisioning.spark.workloads.core.context.cdpPrivate.hdfs

import it.agilelab.provisioning.spark.workloads.core.context.cdpPrivate.ApplicationConfigurationCore
import it.agilelab.provisioning.spark.workloads.core.context.cdpPrivate.httpclient.HttpClientWrapper
...
object HdfsClient {
  ...
  def findActiveNameNode(
    ...
    clusters.find { clusterUrl =>
      val response = client.executeGet(clusterUrl)
